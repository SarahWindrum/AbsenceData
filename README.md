...
My analysis uses Python code in PySpark. The dataset is available in CSV format and my PySpark code in Jupyter Notebook. The full report with Appendices including instructions on the installation of PySpark on a Windows 10 machine is available here 
